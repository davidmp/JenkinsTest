              ...
              <div class="tablecontainer">
                          <c:if test="${!empty ListaUsuario}">
                            <table >
                                ...
                                <tr>
                                    <td><c:out value="${dato.idPersona.usuario}"/></td>
                                    <td><c:out value="${dato.idPersona.nombre}"/></td>
                                    <td><c:out value="${dato.idPersona.apellidos}"/></td>
                                    <td><c:out value="${dato.idPersona.dnicodigo}"/></td>                                    
                                    <td></td>
                                    <td>
